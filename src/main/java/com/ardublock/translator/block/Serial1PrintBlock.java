...
public class Serial1PrintBlock extends TranslatorBlock
{
	public Serial1PrintBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
